...
STUB_WEAPON_CLASS( weapon_ar2_comb, WeaponAR2Combine, C_HLMachineGun);
STUB_WEAPON_CLASS(weapon_frag_combine, WeaponFragCombine, C_BaseHLCombatWeapon);
...
STUB_WEAPON_CLASS(weapon_shotgun_combine, WeaponShotgunCombine, C_BaseHLCombatWeapon);
STUB_WEAPON_CLASS( weapon_smg1, WeaponSMG1, C_HLSelectFireMachineGun );
STUB_WEAPON_CLASS(weapon_smg1_combine, WeaponSMG1Combine, C_HLSelectFireMachineGun);
