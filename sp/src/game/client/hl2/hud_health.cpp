...
private:
	// old variables
	CPanelAnimationVarAliasType(float, center_x, "center_x", "0", "proportional_float");
	CPanelAnimationVarAliasType(float, digit_ypos, "digit_ypos", "1", "proportional_float");
...
void CHudHealth::OnThink()
{
	...
	SetDisplayValue(m_iHealth);
	surface()->DrawSetTextPos(center_x, digit_ypos);
