...
class C_NPC_SuppressorFlyGenerator : public C_AI_BaseNPC
{
public:
	C_NPC_SuppressorFlyGenerator() {}

	DECLARE_CLASS(C_NPC_SuppressorFlyGenerator, C_AI_BaseNPC);
	DECLARE_CLIENTCLASS();
	DECLARE_DATADESC();
...
private:
	C_NPC_SuppressorFlyGenerator(const C_NPC_SuppressorFlyGenerator &);
...
// Save/restore
//-----------------------------------------------------------------------------
BEGIN_DATADESC(C_NPC_SuppressorFlyGenerator)
...
// Networking
//-----------------------------------------------------------------------------
IMPLEMENT_CLIENTCLASS_DT(C_NPC_SuppressorFlyGenerator, DT_SuppressorFlyGenerator, CNPC_SuppressorFlyGenerator)
...
// Purpose: Start the manhack's engine sound.
//-----------------------------------------------------------------------------
void C_NPC_SuppressorFlyGenerator::OnDataChanged(DataUpdateType_t type)
{
...
// Restore
//-----------------------------------------------------------------------------
void C_NPC_SuppressorFlyGenerator::OnRestore()
{
	BaseClass::OnRestore();
	SoundInit();
}
...
// Purpose: Start the manhack's engine sound.
//-----------------------------------------------------------------------------
void C_NPC_SuppressorFlyGenerator::UpdateOnRemove(void)
{
...
// Purpose: Start the manhack's engine sound.
//-----------------------------------------------------------------------------
void C_NPC_SuppressorFlyGenerator::SoundInit(void)
{
	if ((m_nEnginePitch1 < 0) || (m_nEnginePitch2 < 0))
		return;
...
// Purpose:
//-----------------------------------------------------------------------------
void C_NPC_SuppressorFlyGenerator::SoundShutdown(void)
{
	// Kill the engine!
	if (m_pEngineSound1)
	{
