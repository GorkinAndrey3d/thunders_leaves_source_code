...
ConVar	sk_max_rebel_ar2("sk_max_rebel_ar2", "0", FCVAR_REPLICATED);
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("Buckshot",			DMG_BULLET | DMG_BUCKSHOT, TRACER_LINE_AND_WHIZ,			"sk_plr_dmg_buckshot",		"sk_npc_dmg_buckshot",		"sk_max_buckshot",		BULLET_IMPULSE(400, 1200), 0 ); //400 1200
...
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		...
		def.AddAmmoType("Rebel_Ar2", DMG_BULLET, TRACER_LINE_AND_WHIZ, "sk_plr_dmg_ar2", "sk_npc_dmg_ar2", "sk_max_rebel_ar2", BULLET_IMPULSE(200, 1225), 0);
		//=====================================================================
