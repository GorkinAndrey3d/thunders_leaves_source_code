...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_INSPECT);
	REGISTER_SHARED_ACTIVITY(ACT_VM_READY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SECONDARYATTACK_NO_RELOAD);
	REGISTER_SHARED_ACTIVITY(ACT_VM_WALK);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPRINT);
