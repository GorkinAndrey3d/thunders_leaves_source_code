#ifndef NPC_electrohack_H
#define NPC_electrohack_H
#ifdef _WIN32
#pragma once
#endif
...
// Manhack 
//-----------------------------------------------------------------------------
class CNPC_Suppressorelectrohack : public CNPCBaseInteractive<CAI_BasePhysicsFlyingBot>, public CDefaultPlayerPickupVPhysics
{
	DECLARE_CLASS(CNPC_Suppressorelectrohack, CNPCBaseInteractive<CAI_BasePhysicsFlyingBot>);
	DECLARE_SERVERCLASS();

public:
	CNPC_Suppressorelectrohack();
	~CNPC_Suppressorelectrohack();
...
#define ENTITY_MODEL_ELECTROHACK "models/manhack.mdl"
