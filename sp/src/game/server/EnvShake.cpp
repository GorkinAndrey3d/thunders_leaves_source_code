...
public:
	...
	void InputRevolverShake(inputdata_t &inputdata);
...
BEGIN_DATADESC( CEnvShake )
	...
	DEFINE_INPUTFUNC(FIELD_VOID, "RevolverShake", InputRevolverShake),
...
void CEnvShake::InputRevolverShake(inputdata_t &inputdata)
{
...
static ConCommand shake_revolver("shake_revolver", CC_Shake_Revolver, "Shake the screen.", FCVAR_CHEAT);
