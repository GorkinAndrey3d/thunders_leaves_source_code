...
ConVar	sk_electrohack_health("sk_manhack_health", "0");
ConVar	sk_electrohack_melee_dmg("sk_manhack_melee_dmg", "0");
ConVar	sk_electrohack_v2("sk_manhack_v2", "1");
...
// Private activities.
//-----------------------------------------------------------------------------
Activity ACT_electrohack_UNPACK;
...
BEGIN_DATADESC(CNPC_Suppressorelectrohack)
...
LINK_ENTITY_TO_CLASS(npc_electrohack, CNPC_Suppressorelectrohack);

IMPLEMENT_SERVERCLASS_ST(CNPC_Suppressorelectrohack, DT_electrohack)
...
// Output  :
//------------------------------------------------------------------------------
CNPC_Suppressorelectrohack::CNPC_Suppressorelectrohack()
{
#ifdef _DEBUG
...
//-----------------------------------------------------------------------------
Class_T	CNPC_Suppressorelectrohack::Classify(void)
{
...
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::Event_Dying(void)
{
	DestroySmokeTrail();
	SetHullSizeNormal();
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::GatherConditions()
{
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::PrescheduleThink(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::TraceAttack(const CTakeDamageInfo &info, const Vector &vecDir, trace_t *ptr, CDmgAccumulator *pAccumulator)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::DeathSound(const CTakeDamageInfo &info)
{
...
//-----------------------------------------------------------------------------
bool CNPC_Suppressorelectrohack::ShouldGib(const CTakeDamageInfo &info)
{
	return (m_bGib);
}
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::Event_Killed(const CTakeDamageInfo &info)
{
	// turn off the blur!
...
void CNPC_Suppressorelectrohack::HitPhysicsObject(CBaseEntity *pOther)
{
...
void CNPC_Suppressorelectrohack::TakeDamageFromPhyscannon(CBasePlayer *pPlayer)
{
...
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::TakeDamageFromVehicle(int index, gamevcollisionevent_t *pEvent)
{
...
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::TakeDamageFromPhysicsImpact(int index, gamevcollisionevent_t *pEvent)
{
...
void CNPC_Suppressorelectrohack::VPhysicsCollision(int index, gamevcollisionevent_t *pEvent)
{
...
void CNPC_Suppressorelectrohack::VPhysicsShadowCollision(int index, gamevcollisionevent_t *pEvent)
{
	int otherIndex = !index;
	CBaseEntity *pOther = pEvent->pEntities[otherIndex];
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::CrashTouch(CBaseEntity *pOther)
{
...
// Create smoke trail!
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::CreateSmokeTrail()
{
...
void CNPC_Suppressorelectrohack::DestroySmokeTrail()
{
...
// Output :
//-----------------------------------------------------------------------------
int	CNPC_Suppressorelectrohack::OnTakeDamage_Alive(const CTakeDamageInfo &info)
{
...
// Purpose:
//------------------------------------------------------------------------------
bool CNPC_Suppressorelectrohack::CorpseGib(const CTakeDamageInfo &info)
{
...
// Output :
//-----------------------------------------------------------------------------
int	CNPC_Suppressorelectrohack::OnTakeDamage_Dying(const CTakeDamageInfo &info)
{
...
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::OnStateChange(NPC_STATE OldState, NPC_STATE NewState)
{
...
// Input  : Type - 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::HandleAnimEvent(animevent_t *pEvent)
{
...
//-----------------------------------------------------------------------------
bool CNPC_Suppressorelectrohack::IsFlyingActivity(Activity baseAct)
{
...
// Input  : Type - 
//-----------------------------------------------------------------------------
Activity CNPC_Suppressorelectrohack::NPC_TranslateActivity(Activity baseAct)
{
...
// Input  : Type - 
//-----------------------------------------------------------------------------
int CNPC_Suppressorelectrohack::TranslateSchedule(int scheduleType)
{
...
void CNPC_Suppressorelectrohack::Loiter()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::MaintainGroundHeight(void)
{
...
// Input  : flInterval - 
//-----------------------------------------------------------------------------
bool CNPC_Suppressorelectrohack::OverrideMove(float flInterval)
{
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::TurnHeadRandomly(float flInterval)
{
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::MoveToTarget(float flInterval, const Vector &vMoveTarget)
{
...
void CNPC_Suppressorelectrohack::EnableDefence(inputdata_t &inputData)
{
...
void CNPC_Suppressorelectrohack::EnableDefenceVoid(void)
{
	Vector SparkOrigin = GetAbsOrigin();
	Vector vecDir33 = vec3_origin;
	DoSpark(this, SparkOrigin, 1.0f, 1.0f, true, vecDir33);
...
void CNPC_Suppressorelectrohack::DefenceThink(void)
{
...
// Output :
//-----------------------------------------------------------------------------
int CNPC_Suppressorelectrohack::MoveCollisionMask(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::Splash(const Vector &vecSplashPos)
{
	CEffectData	data;
...
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::ComputeSliceBounceVelocity(CBaseEntity *pHitEntity, trace_t &tr)
{
...
//-----------------------------------------------------------------------------
bool CNPC_Suppressorelectrohack::IsHeldByPhyscannon()
{
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::Slice(CBaseEntity *pHitEntity, float flInterval, trace_t &tr)
{
	...
	float flDamage = sk_electrohack_melee_dmg.GetFloat() * flInterval;
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::Bump(CBaseEntity *pHitEntity, float flInterval, trace_t &tr)
{
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::CheckCollisions(float flInterval)
{
...
void CNPC_Suppressorelectrohack::PlayFlySound(void)
{
	float flEnemyDist;
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::MoveExecute_Alive(float flInterval)
{
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::SpinBlades(float flInterval)
{
	if (!m_bBladesActive)
	{
...
/*
void CNPC_Suppressorelectrohack::DefenceStateOne(float flInterval)
{
...
*/
void CNPC_Suppressorelectrohack::BreakControl(float flInterval)
{
	
}


void CNPC_Suppressorelectrohack::CreateGlow(bool DefenceEnabledVoid)
{
...
void CNPC_Suppressorelectrohack::ChangeHealth(bool DefenceEnabledVoid)
{
...
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::MoveExecute_Dead(float flInterval)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::Precache(void)
{
	//
	// Model.
	//
	PrecacheModel(ENTITY_MODEL_ELECTROHACK);
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::GatherEnemyConditions(CBaseEntity *pEnemy)
{
...
// Output :
//-----------------------------------------------------------------------------
int CNPC_Suppressorelectrohack::MeleeAttack1Conditions(float flDot, float flDist)
{
	if (GetEnemy() == NULL)
		return COND_NONE;
...
// Input  : *pTask - 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::RunTask(const Task_t *pTask)
{
	switch (pTask->iTask)
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::Spawn(void)
{
	Precache();
	...
	SetModel(ENTITY_MODEL_ELECTROHACK);
	...
	m_iHealth = sk_electrohack_health.GetFloat();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::StartEye(void)
{
...
void CNPC_Suppressorelectrohack::Activate()
{
	BaseClass::Activate();
...
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::PostNPCInit(void)
{
...
void CNPC_Suppressorelectrohack::BladesInit()
{
	if (!m_bBladesActive)
	{
...
// Crank up the engine!
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::StartEngine(bool fStartSound)
{
	if (fStartSound)
	{
		SoundInit();
...
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::SoundInit(void)
{
	m_nEnginePitch1 = MANHACK_MIN_PITCH1;
...
// Purpose:
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::StopLoopingSounds(void)
{
...
// Input  : pTask - 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::StartTask(const Task_t *pTask)
{
	switch (pTask->iTask)
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::UpdateOnRemove(void)
{
	DestroySmokeTrail();
	KillSprites(0.0);
...
//-----------------------------------------------------------------------------
bool CNPC_Suppressorelectrohack::HandleInteraction(int interactionType, void* data, CBaseCombatCharacter* sourceEnt)
{
...
// Output : float
//-----------------------------------------------------------------------------
float CNPC_Suppressorelectrohack::ManhackMaxSpeed(void)
{
	if (m_flWaterSuspendTime > gpGlobals->curtime)
	{
		// Slower in water!
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::ClampMotorForces(Vector &linear, AngularImpulse &angular)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::KillSprites(float flDelay)
{
	if (m_pEyeGlow)
	{
...
//-----------------------------------------------------------------------------
bool CNPC_Suppressorelectrohack::IsInEffectiveTargetZone(CBaseEntity *pTarget)
{
...
//			&tolerance - 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::TranslateNavGoal(CBaseEntity *pEnemy, Vector &chasePosition)
{
...
float CNPC_Suppressorelectrohack::GetDefaultNavGoalTolerance()
{
	return GetHullWidth();
}
...
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::InputDisableSwarm(inputdata_t &inputdata)
{
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::InputUnpack(inputdata_t &inputdata)
{
...
//			reason - 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::OnPhysGunPickup(CBasePlayer *pPhysGunUser, PhysGunPickup_t reason)
{
...
//			Reason - 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::OnPhysGunDrop(CBasePlayer *pPhysGunUser, PhysGunDrop_t Reason)
{
...
void CNPC_Suppressorelectrohack::StartLoitering(const Vector &vecLoiterPosition)
{
	//Msg("Start Loitering\n");
...
CBasePlayer *CNPC_Suppressorelectrohack::HasPhysicsAttacker(float dt)
{
...
//-----------------------------------------------------------------------------
float CNPC_Suppressorelectrohack::GetMaxEnginePower()
{
	if (m_bHackedByAlyx)
	{
		return 2.0f;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::UpdatePanels(void)
{
	if (m_flEngineStallTime > gpGlobals->curtime)
	{
...
// Input  : hostile - 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::ShowHostile(bool hostile /*= true*/)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::StartBurst(const Vector &vecDirection)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::StopBurst(bool bInterruptSchedule /*= false*/)
{
	if (m_flBurstDuration < gpGlobals->curtime)
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Suppressorelectrohack::SetEyeState(int state)
{
...
unsigned int CNPC_Suppressorelectrohack::PhysicsSolidMaskForEntity(void) const
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Suppressorelectrohack::CreateVPhysics(void)
{
	if (HasSpawnFlags(SF_MANHACK_CARRIED))
		return false;
...
//
//-----------------------------------------------------------------------------
AI_BEGIN_CUSTOM_NPC(npc_suppressorelectrohack, CNPC_Suppressorelectrohack)
...
DECLARE_ACTIVITY(ACT_electrohack_UNPACK);
...
(
	...
	"	Tasks"
	"		TASK_PLAY_SEQUENCE			ACTIVITY:ACT_electrohack_UNPACK"
	"		TASK_SET_ACTIVITY			ACTIVITY:ACT_FLY"
	"	"
	//	"	Interrupts"
);
