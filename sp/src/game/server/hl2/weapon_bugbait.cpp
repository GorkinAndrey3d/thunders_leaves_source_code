...
void CWeaponBugBait::Precache( void )
{
	...
	PrecacheScriptSound("Weapon_transmitter.beep");
}
...
void CWeaponBugBait::PrimaryAttack( void )
{
	...
	SendWeaponAnim(ACT_VM_SECONDARYATTACK);//ACT_VM_HAULBACK 
	...
	EmitSound(filter, entindex(), "Weapon_transmitter.beep");
...
void CWeaponBugBait::SecondaryAttack( void )
{
	...
	SendWeaponAnim(ACT_VM_SECONDARYATTACK);//ACT_VM_SECONDARYATTACK
