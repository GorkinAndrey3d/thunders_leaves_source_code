...
#define ENV_HEADCRABCANISTER_SET4_MODEL	"models/props_combine/headcrabcannister01b_set4.mdl"
#define ENV_HEADCRABCANISTER_SET5_MODEL	"models/props_combine/headcrabcannister01b_set5.mdl"
#define ENV_HEADCRABCANISTER_SET6_MODEL	"models/props_combine/headcrabcannister01b_set6.mdl"
...
public:
	...
	void	CannisterTouch(CBaseEntity *pOther);
...
private:
	...
	void				InputSetModel_Set4(inputdata_t &inputdata);
	void				InputSetModel_Set5(inputdata_t &inputdata);
	void				InputSetModel_Set6(inputdata_t &inputdata);
	void				InputSetModel_SetNull(inputdata_t &inputdata);
	// Think(s)
...
private:
	...
	COutputEvent m_OnTouchSet4;
	COutputEvent m_OnTouchSet5;
	COutputEvent m_OnTouchSet6;
...
BEGIN_DATADESC( CEnvHeadcrabCanister )
	...
	DEFINE_INPUTFUNC(FIELD_VOID, "SetModel_Set4", InputSetModel_Set4),
	DEFINE_INPUTFUNC(FIELD_VOID, "SetModel_Set5", InputSetModel_Set5),
	DEFINE_INPUTFUNC(FIELD_VOID, "SetModel_Set6", InputSetModel_Set6),
	DEFINE_INPUTFUNC(FIELD_VOID, "SetModel_Set_null", InputSetModel_SetNull),
	// Outputs
	DEFINE_OUTPUT( m_OnLaunched, "OnLaunched" ),
	DEFINE_OUTPUT( m_OnImpacted, "OnImpacted" ),
	DEFINE_OUTPUT( m_OnOpened, "OnOpened" ),
	DEFINE_OUTPUT(m_OnTouchSet4, "OnTouchSet4"),
	DEFINE_OUTPUT(m_OnTouchSet5, "OnTouchSet5"),
	DEFINE_OUTPUT(m_OnTouchSet6, "OnTouchSet6"),

	DEFINE_ENTITYFUNC(CannisterTouch),
...
void CEnvHeadcrabCanister::Precache( void )
{
	...
	PrecacheModel(ENV_HEADCRABCANISTER_SET4_MODEL);
	PrecacheModel(ENV_HEADCRABCANISTER_SET5_MODEL);
	PrecacheModel(ENV_HEADCRABCANISTER_SET6_MODEL);
...
void CEnvHeadcrabCanister::Spawn( void )
{
	Precache();
	BaseClass::Spawn();
	SetTouch(&CEnvHeadcrabCanister::CannisterTouch);
...
void CEnvHeadcrabCanister::CannisterTouch(CBaseEntity * pOther)
{
	...
	if (pOther->IsPlayer())
	{
		//m_OnTouchSet4.FireOutput(pOther, pOther);
		//SetModel(ENV_HEADCRABCANISTER_BROKEN_MODEL);
		switch (m_nCannisterSet)
		{
		case 0:
			break;
		case 4:
			...
			break;
		case 5:
			m_OnTouchSet5.FireOutput(pOther, pOther);
			SetModel(ENV_HEADCRABCANISTER_BROKEN_MODEL);
			m_nCannisterSet = 0;
			break;
		case 6:
			m_OnTouchSet6.FireOutput(pOther, pOther);
			SetModel(ENV_HEADCRABCANISTER_BROKEN_MODEL);
			m_nCannisterSet = 0;
			break;
		default:
...
void CEnvHeadcrabCanister::InputSetModel_Set4(inputdata_t & inputdata)
{
	SetModel(ENV_HEADCRABCANISTER_SET4_MODEL);
	m_nCannisterSet = 4;
}

void CEnvHeadcrabCanister::InputSetModel_Set5(inputdata_t & inputdata)
{
	SetModel(ENV_HEADCRABCANISTER_SET5_MODEL);
	m_nCannisterSet = 5;
}

void CEnvHeadcrabCanister::InputSetModel_Set6(inputdata_t & inputdata)
{
	SetModel(ENV_HEADCRABCANISTER_SET6_MODEL);
	m_nCannisterSet = 6;
}

void CEnvHeadcrabCanister::InputSetModel_SetNull(inputdata_t & inputdata)
{
	SetModel(ENV_HEADCRABCANISTER_BROKEN_MODEL);
}
