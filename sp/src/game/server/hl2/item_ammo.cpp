...
public:
	...
	{
		Precache();
		SetModel("models/items/ar2_mach_box.mdl");
		BaseClass::Spawn();
	}
	void Precache(void)
	{
		PrecacheModel("models/items/ar2_mach_box.mdl");
	}
	bool MyTouch(CBasePlayer *pPlayer)
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_AR2, "Rebel_Ar2"))
		{
			if (g_pGameRules->ItemShouldRespawn(this) == GR_ITEM_RESPAWN_NO)
			{
				UTIL_Remove(this);
...
LINK_ENTITY_TO_CLASS(item_box_ar2_rebel_rounds, CItem_BoxAR2Rounds);
LINK_ENTITY_TO_CLASS(item_ammo_ar2_rebel, CItem_BoxAR2Rounds);

// ========================================================================
//	>> AR2_REBEL_BOX_LARGE
// ========================================================================
class CItem_Large_BoxAR2Rounds : public CItem
{
public:
	DECLARE_CLASS(CItem_Large_BoxAR2Rounds, CItem);

	void Spawn(void)
	{
		Precache();
		SetModel("models/items/ar2_mach_box_large.mdl");
		BaseClass::Spawn();
	}
	void Precache(void)
	{
		PrecacheModel("models/items/ar2_mach_box_large.mdl");
	}
	bool MyTouch(CBasePlayer *pPlayer)
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_AR2_LARGE, "Rebel_Ar2"))
		{
			if (g_pGameRules->ItemShouldRespawn(this) == GR_ITEM_RESPAWN_NO)
			{
				UTIL_Remove(this);
...
LINK_ENTITY_TO_CLASS(item_large_box_ar2_rebel_rounds, CItem_Large_BoxAR2Rounds);
LINK_ENTITY_TO_CLASS(item_ammo_ar2_rebel_large, CItem_Large_BoxAR2Rounds);
