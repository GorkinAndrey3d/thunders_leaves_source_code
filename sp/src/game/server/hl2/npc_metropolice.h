...
public:
	CNPC_MetroPolice();
	void UnlinkChild(inputdata_t &inputdata);
	virtual bool CreateComponents();
	bool CreateBehaviors();
	bool Shield = false;
	void Spawn( void );
	void Precache( void );
	void CreateShield(inputdata_t &inputdata);
...
class CTLSuppressorShield_Attach : public CBaseAnimating
{
public:
	DECLARE_CLASS(CTLSuppressorShield_Attach, CBaseAnimating);
	DECLARE_DATADESC();

	CTLSuppressorShield_Attach()
	{
		m_bActive = false;
	}
	void Spawn(void);
