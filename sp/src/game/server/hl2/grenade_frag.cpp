...
#define FRAG_GRENADE_WARN_TIME 1.7f //1.5
...
#define GRENADE_MODEL "models/Weapons/w_grenade_rebel.mdl"
...
void CGrenadeFrag::CreateEffects( void )
{
	...
	if ( m_pMainGlow != NULL )
	{
		...
		m_pMainGlow->SetColor(255, 100, 0);
	...
	if ( m_pGlowTrail != NULL )
	{
		...
		m_pGlowTrail->SetColor(255, 70, 0);
