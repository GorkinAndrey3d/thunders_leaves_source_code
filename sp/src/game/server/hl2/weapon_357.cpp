...
void CWeapon357::PrimaryAttack( void )
{
	...
	Vector revolver_cone;
	if (m_bIsIronsighted)
	{
		revolver_cone = VECTOR_CONE_1DEGREES;
	}
	else
	{
		revolver_cone = VECTOR_CONE_5DEGREES;
	}
	pPlayer->FireBullets(1, vecSrc, vecAiming, revolver_cone, MAX_TRACE_LENGTH, m_iPrimaryAmmoType, 0);
