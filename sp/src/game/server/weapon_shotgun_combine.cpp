...
class CWeaponShotgunCombine : public CBaseHLCombatWeapon
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponShotgunCombine, CBaseHLCombatWeapon);
...
public:
	...
	CWeaponShotgunCombine(void);
};

IMPLEMENT_SERVERCLASS_ST(CWeaponShotgunCombine, DT_WeaponShotgunCombine)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_shotgun_combine, CWeaponShotgunCombine);
PRECACHE_WEAPON_REGISTER(weapon_shotgun_combine);

BEGIN_DATADESC(CWeaponShotgunCombine)
...
acttable_t	CWeaponShotgunCombine::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponShotgunCombine);

void CWeaponShotgunCombine::Precache(void)
{
...
// Input  : *pOperator - 
//-----------------------------------------------------------------------------
void CWeaponShotgunCombine::FireNPCPrimaryAttack(CBaseCombatCharacter *pOperator, bool bUseWeaponAngles)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponShotgunCombine::Operator_ForceNPCFire(CBaseCombatCharacter *pOperator, bool bSecondary)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgunCombine::Operator_HandleAnimEvent(animevent_t *pEvent, CBaseCombatCharacter *pOperator)
{
	switch (pEvent->event)
	{
...
//-----------------------------------------------------------------------------
float CWeaponShotgunCombine::GetMinRestTime()
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
float CWeaponShotgunCombine::GetMaxRestTime()
{
	if (hl2_episodic.GetBool() && GetOwner() && GetOwner()->Classify() == CLASS_COMBINE)
	{
		return 1.5f;
...
//-----------------------------------------------------------------------------
float CWeaponShotgunCombine::GetFireRate()
{
	if (hl2_episodic.GetBool() && GetOwner() && GetOwner()->Classify() == CLASS_COMBINE)
	{
		return 0.8f;
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponShotgunCombine::StartReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponShotgunCombine::Reload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgunCombine::FinishReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgunCombine::FillClip(void)
{
	CBaseCombatCharacter *pOwner = GetOwner();
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgunCombine::Pump(void)
{
	CBaseCombatCharacter *pOwner = GetOwner();
...
//
//-----------------------------------------------------------------------------
void CWeaponShotgunCombine::DryFire(void)
{
	WeaponSound(EMPTY);
...
//
//-----------------------------------------------------------------------------
void CWeaponShotgunCombine::PrimaryAttack(void)
{
...
//
//-----------------------------------------------------------------------------
void CWeaponShotgunCombine::SecondaryAttack(void)
{
	// Only the player fires this way so we can cast
	CBasePlayer *pPlayer = ToBasePlayer(GetOwner());
...
//-----------------------------------------------------------------------------
void CWeaponShotgunCombine::ItemPostFrame(void)
{
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CWeaponShotgunCombine::CWeaponShotgunCombine(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponShotgunCombine::ItemHolsterFrame(void)
{
	// Must be player held
...
//==================================================
/*
void CWeaponShotgunCombine::WeaponIdle( void )
{
//Only the player fires this way so we can cast
